<h1 align="center">
    <img alt="Podcastr" title="Podcastr" src=".github/logo.svg" width="370px" />
</h1>
...
```bash
$ git clone https://github.com/sdavi38/podcastr-nlw5.git
```
...
<p align="center">Projected by David Bernardo with 🖤</p>
